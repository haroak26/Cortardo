      ...
      <div className="max-w-3xl mx-auto px-8 py-16 md:py-24 space-y-16">
        ...
        <Section title="The Cortardo Agent">
          ...
          <Collapsible title="Model selection">
            <p>Runs are powered by models served through OpenRouter. Override the default with the <code className="text-[12px] bg-surface-hover px-1.5 py-0.5 rounded">CODEBOT_MODEL</code> environment variable.</p>
          </Collapsible>
        </Section>
