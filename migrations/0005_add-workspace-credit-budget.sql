...
ALTER TABLE "workspaces" ADD COLUMN "credit_budget" integer;--> statement-breakpoint
CREATE UNIQUE INDEX "design_patterns_name_idx" ON "design_patterns" USING btree ("name");--> statement-breakpoint
CREATE INDEX "design_patterns_category_idx" ON "design_patterns" USING btree ("category");--> statement-breakpoint
